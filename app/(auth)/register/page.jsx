  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 className="text-center text-white text-4xl font-light mb-10">Sign Up</h1>
          ...
          <div className="flex">
            ...
            <div className="w-1/2 pr-10">
              <form className="space-y-6">
                ...
                <div>
                  <label className="block text-white text-sm mb-2" htmlFor="confirm-password">Confirm Password</label>
                  <input
                    id="confirm-password"
                    type="password"
            ...
            {/* Right Section: Social Buttons and Sign In Link */}
            <div className="w-1/2 pl-10 flex flex-col justify-between">
              ...
              <div className="text-center w-full">
                <a href="/login" className="text-md text-white hover:underline">Already have an account? Sign In</a>
              </div>
            </div>
          </div>
        </div>
